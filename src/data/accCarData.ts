export interface CarConfig {
  ...
  tirePressureMin: number
  casterFunc: (v: number) => number
  toeMins: [number, number]
  wheelRates: [number[], number[]]
  steeringRatioMin: number
  brakeBiasMin: number
...
export const carData: Record<string, CarConfig> = {
  // GT3
  amr_v12_vantage_gt3: {
